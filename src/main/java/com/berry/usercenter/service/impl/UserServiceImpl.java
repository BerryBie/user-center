package com.berry.usercenter.service.impl;
...
import com.berry.usercenter.mapper.UserMapper;
 ...
 * @createDate 2023-03-08 10:24:38
 */
@Service
@Slf4j
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
     ...
     * 盐值混淆密码
     */
    public static final String SALT = "berry";
    ...
    public User getSafetyUser(User originUser){
        ...
        safetyUser.setUserStates(originUser.getUserStates());
